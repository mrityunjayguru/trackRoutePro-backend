export const SuportResolvedMail = (records: any, suportrecord: any) => {
  return `
     <html>
  <body
    style="
            ...
            <tr>
              ...
              >
                ...
                <h1
                  ...
                  "
                >
                  Ticket  <span style="color: #d9e821">Resolved</span>
...
We’re pleased to inform you that your ticket has been successfully resolved.
                </p>
                <p>Ticket Details:</p>
                <div style="width: 100%; display: flex">
                  ...
                  <div style="width: 50%">
                    ...
                    <span style="font-weight: 600;">In Resolved</span>
                  </div>
                </div>
